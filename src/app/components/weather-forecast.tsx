...
function getWeatherIcon(condition: string) {
  switch (condition) {
    ...
    case "clouds":
      return <Cloud className="h-16 w-16 text-gray-700" />;
    case "rain":
    case "drizzle":
...
export function WeatherForecastDisplay({
  ...
  return (
    <div
      className={`glass flex w-full flex-col items-center justify-between gap-4 rounded-lg bg-linear-to-br ${getWeatherGradient(data.Condition)} p-4 text-gray-900 shadow-lg sm:gap-4 sm:p-6`}
    >
      {/* Location */}
      <div className="w-full text-center">
        ...
        <p className="text-xs font-medium capitalize opacity-80 sm:text-sm">
          {data.Description}
        </p>
      </div>
      ...
      <div className="flex w-full items-center justify-center gap-4">
        ...
        <div className="text-center">
          ...
          <div className="mt-1 flex items-center justify-center gap-3 text-sm font-medium opacity-90">
      ...
      {/* Additional Info */}
      <div className="flex w-full items-center justify-around border-t border-gray-900/20 pt-3 text-xs sm:text-sm">
        <div className="flex flex-col items-center gap-1">
          <Wind className="h-5 w-5 opacity-80" />
          <span className="font-semibold">{data.Wind} km/h</span>
          <span className="text-xs font-medium opacity-80">Wind</span>
        </div>
        <div className="flex flex-col items-center gap-1">
