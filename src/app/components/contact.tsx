  ...
  return (
    <MorphingPopover open={isOpen} onOpenChange={setIsOpen}>
      ...
      <MorphingPopoverContent className="z-50 h-screen w-screen overflow-y-auto">
        ...
        <div className="min-h-screen w-screen bg-slate-950/85 backdrop-blur-2xl p-4 pt-20 text-white sm:p-6 sm:pt-24 md:p-8 md:pt-28 lg:p-12">
          <div className="mb-6 text-center sm:mb-8 md:mb-12">
            <h1 className="mb-2 text-3xl font-bold text-white sm:mb-4 sm:text-4xl md:text-5xl lg:text-6xl tracking-tight">
              Get In Touch
            </h1>
            <p className="text-sm text-amber-200/80 sm:text-base md:text-lg">
          ...
          <div className="mx-auto max-w-4xl space-y-6 sm:space-y-8">
            {/* Email */}
            <div className="glass-matte-card p-6 sm:p-8">
              <div className="mb-4 flex items-center gap-3">
                <div className="glass-matte-button p-2.5">
              ...
              <div className="glass-matte-card flex items-center justify-between p-4">
                <a
                ...
                <button
                  ...
                  className="glass-matte-button px-3 py-1.5 text-xs"
              ...
              {copiedEmail && (
                <p className="mt-2 text-center text-sm font-medium text-emerald-300">
            ...
            <div className="glass-matte-card p-6 sm:p-8">
              ...
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                <a
                  ...
                  className="group glass-matte-card flex flex-col items-center gap-3 p-5 text-white"
                >
                  <svg
                    className="h-9 w-9 fill-blue-400 transition group-hover:scale-105"
                    role="img"
                    viewBox="0 0 24 24"
                  >
                ...
                >
                  <svg
                    className="h-9 w-9 fill-white transition group-hover:scale-105"
                    role="img"
                    viewBox="0 0 24 24"
                  >
                ...
                >
                  <svg
                    className="h-9 w-9 fill-sky-400 transition group-hover:scale-105"
                    role="img"
                    viewBox="0 0 24 24"
                  >
                ...
                >
                  <svg
                    className="h-9 w-9 fill-rose-400 transition group-hover:scale-105"
                    role="img"
                    viewBox="0 0 24 24"
                  >
            ...
            {/* Availability */}
            <div className="glass-matte-card p-6 text-center sm:p-8">
              <div className="mb-3 inline-block rounded-full bg-emerald-500/15 border border-emerald-400/30 px-4 py-1.5">
